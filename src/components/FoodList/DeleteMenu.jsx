...
const DeleteMenu = () => {
  ...
  useEffect(() => {
    const fetchMenus = async () => {
      try {
        const response = await axios.get('https://66505467ec9b4a4a60319fe4.mockapi.io/api/menusemanal/menus');
  ...
  const handleDeleteMeal = async (menuId, dayIndex, mealIndex) => {
    try {
      ...
      await axios.put(`https://66505467ec9b4a4a60319fe4.mockapi.io/api/menusemanal/menus/${menuId}`, { days: updatedMenus.find(menu => menu.id === menuId).days });
